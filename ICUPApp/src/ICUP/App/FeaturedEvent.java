...
public class FeaturedEvent extends ICUPActivity {
     ...
     * (non-Javadoc)
     * @see ICUP.App.ICUPActivity#onCreate(android.os.Bundle)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see ICUP.App.ICUPActivity#onPause()
     */
    @Override
	public void onPause(){
    	super.onPause();
     ...
     * (non-Javadoc)
     * @see ICUP.App.ICUPActivity#onResume()
     */
    @Override
