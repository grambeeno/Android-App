 ...
 */
public class BusinessAdapter extends ArrayAdapter<OrganizationDTO>
{
    ...
    public BusinessAdapter(Activity parent,Context context, int textViewResourceId, ArrayList<OrganizationDTO> items, boolean isFavorites) {
    ...
    /**
     * Place the content from the business item into objects in the list view
     */
    @Override
