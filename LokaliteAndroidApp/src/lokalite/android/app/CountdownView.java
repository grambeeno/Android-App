...
public class CountdownView extends TextView {
	...
	public CountdownView(Context context, AttributeSet attrs) {
		...
		this.time = attrs.getAttributeValue("http://schemas.android.com/apk/res/lokalite.android.app", "setEndTime");
		Log.i(TAG, "String time="+time);
		// Grab the end time from the XML file and convert it into a long
		this.endTime = Long.parseLong(attrs.getAttributeValue("http://schemas.android.com/apk/res/lokalite.android.app", "setEndTime"));
